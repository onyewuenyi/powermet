...
COLUMNS: tuple[ColumnSpec, ...] = (
    ...
    ColumnSpec("activity", "float", FEATURE, non_negative=True, description="Average toggle activity factor (0..1+)"),
    ...
    ColumnSpec("bits_per_cycle", "float", FEATURE, non_negative=True, description="Average data bits moved per cycle (workload-specific)"),
